...
import { ToastService, MessageBoxService, MessageBoxComponent } from "../rui";
...
import { IMService, ConnectStatus } from "../app/im";
...
import {Command, RCResponse} from "../app/im/rc/proto";
...
export class AppComponent implements OnInit {
    ...
    connectIM() {
        ...
        // this.im.connect('ws://' + document.location.host + ':8102/im/' + (<any>window).ROOM_NO);
    }
